...
while (count < 10) {
    ...
    if (+guess == randomNumber) {
        main.innerHTML = `It took you ${count} times to guess the number ${randomNumber}`;
        break;
    } else {
        main.innerHTML = `Next time try better.`
    }
}
...
//     guess = prompt('I am thinking of a number between 1 and 10. What is it?');
//     if (+guess == randomNumber) {
//       main.innerHTML = `It took you ${i} times to guess the number ${randomNumber}`;
//       break;
//     } else {
//       main.innerHTML = `Next time try better.`
//     }
